...
export function DesignsByStatusChart({ data }: { data: { label: string; value: number }[] }) {
  if (data.length === 0) {
    return <EmptyState icon={BarChart3} title="No design previews yet" className="border-none py-10" />;
  }
